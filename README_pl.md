...
# Django Example dla YunoHost

[![Poziom integracji](https://apps.yunohost.org/badge/integration/django_example)](https://ci-apps.yunohost.org/ci/apps/django_example/)
![Status działania](https://apps.yunohost.org/badge/state/django_example)
![Status utrzymania](https://apps.yunohost.org/badge/maintained/django_example)

[![Zainstaluj Django Example z YunoHost](https://install-app.yunohost.org/install-with-yunohost.svg)](https://install-app.yunohost.org/?app=django_example)

*[Przeczytaj plik README w innym języku.](./ALL_README.md)*

> *Ta aplikacja pozwala na szybką i prostą instalację Django Example na serwerze YunoHost.*  
...
**Dostarczona wersja:** 0.2.0~ynh4
## Dokumentacja i zasoby

- Repozytorium z kodem źródłowym: <https://github.com/jedie/django-example>
- Sklep YunoHost: <https://apps.yunohost.org/app/django_example>
- Zgłaszanie błędów: <https://github.com/YunoHost-Apps/django_example_ynh/issues>

## Informacje od twórców

Wyślij swój pull request do [gałęzi `testing`](https://github.com/YunoHost-Apps/django_example_ynh/tree/testing).
